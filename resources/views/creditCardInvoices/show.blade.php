        ...
        <div class="box box-primary">
            <div class="box-body">
                <table class="table table-bordered" id="account-statements-table">
                    <tr>
                        <td colspan="7">{{ 'Previous Invoice: R$ '. number_format(0, 2, ',', '.')  }}</td>
                    </tr>
                    <tr>
                    ...
                    @foreach($creditCardInvoice->movements as $movement)
                        <tr>
                    ...
                    @endforeach
                    <tr>
                        <td colspan="7">{{ 'Credits: R$ '. number_format($credits, 2, ',', '.') . ' ' . 'Debits: R$ ' . number_format($debits, 2, ',', '.') . ' ' . 'Balance: R$ ' . number_format((0 + $credits - $debits), 2, ',', '.')  }}</td>
                    </tr>
                </table>
                ...
                <section class="content-footer">
                    <div class="dt-buttons btn-group" style="margin-left:0px; margin-bottom:10px">
                        <a class="btn btn-default" href="{!! route('creditCardInvoices.index') !!}">Voltar</a>
                    </div>
                </section>
            </div>
        </div>
