        ...
        <div class="box box-primary">
            <div class="box-body">
                <table class="table table-bordered" id="account-statements-table">
                    <tr>
                        <td colspan="7">{{ 'Previous Balance: R$ '. number_format($previous_balance, 2, ',', '.')  }}</td>
                    </tr>
                    <tr>
                    ...
                    @endforeach
                    <tr>
                        <td colspan="7">{{ 'Credits: R$ '. number_format($credits, 2, ',', '.') . ' ' . 'Debits: R$ ' . number_format($debits, 2, ',', '.') . ' ' . 'Balance: R$ ' . number_format(($previous_balance + $credits - $debits), 2, ',', '.')  }}</td>
                    </tr>
                </table>
